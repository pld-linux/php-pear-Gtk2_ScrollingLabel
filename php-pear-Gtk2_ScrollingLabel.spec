...
Przewijająca się etykieta (scrolling label) dla Gtk2. Ta klasa
dostarcza prostego, łatwego do zrozumienia API do ustawiania i
...
ustawienie i pobieranie tekstu oraz jego właściwości.
